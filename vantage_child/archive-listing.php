...
<div id="main" class="list">
	...
	<?php $mapid = current_category_ID(); ?>
	<?php if ( !is_front_page() && have_posts() ) {
	$arg2 = array('w' => '656px','h' => '260px','zoom' => '14', 'cat' => $mapid, 'ismapnormal' => '1');?>
	<div class="catmap">
<?php do_action('wpw_vantage_gmap_code',$arg2); ?>
	</div>
<?php } ?>
...
if ( have_posts() ) : ?>
	...
	<?php if ( is_search() ) : ?>
	<article class="pmsearchlist">
		<h2><?php printf( __( 'Listings found for "%s"', APP_TD ), va_get_search_query_var( 'ls' ), va_get_search_query_var( 'location' ) ); ?></h2>
	</article>
	<?php endif; ?>
...
<?php elseif ( !$featured ) : ?>
	<?php if ( is_search() ) : ?>
	<article class="pmsearchlist">
		<h2><?php printf( __( 'Sorry, no listings were found for "%s"', APP_TD ), va_get_search_query_var( 'ls' ), va_get_search_query_var( 'location' ) ); ?></h2>
	</article>

	...
	<div class="section">
		...
		<div class="section_content">
			...
			<ul class="display_section">
				...
				<?php if ( $manual_subscr && $can_subscribe ) : ?><li><a href="#subscriptions" class="noscroll"><?php _e('Subscriptions', APP_TD); ?></a></li><?php endif; ?>
			...
			<div id="resumes" class="myprofile_section">
				...
				<table cellpadding="0" cellspacing="0" class="data_list">
					<thead>
						<tr>
							<th><?php _e('Resume Name',APP_TD); ?></th>
						...
						<?php if ($my_query->have_posts()) : ?>
							...
							<?php while ($my_query->have_posts()) : ?>
								...
								<tr>
									...
									<td class="actions"><a href="<?php echo add_query_arg('edit', $my_query->post->ID, get_permalink(get_option('jr_job_seeker_resume_page_id'))); ?>"><?php _e('Edit&nbsp;&rarr;',APP_TD); ?></a>&nbsp;<a href="<?php echo add_query_arg('toggle_visibility', $my_query->post->ID); ?>"><?php if ($my_query->post->post_status=='private') _e('Publish',APP_TD); else _e('Hide',APP_TD); ?></a>&nbsp;<a href="<?php echo add_query_arg('delete_resume', $my_query->post->ID); ?>" class="delete"><?php _e('Delete',APP_TD); ?></a></td>

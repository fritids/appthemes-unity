...
class APP_Dashboard extends scbBoxesPage {
	...
	const TWITTER_FEED = 'http://api.twitter.com/1/statuses/user_timeline.rss?screen_name=appthemes';
	...
	function __construct( $args ) {
		...
		$this->boxes = array(
			...
			array( 'twitter', $this->box_icon( 'twitter-bird.png' ) . __( 'Latest Tweets', APP_TD ), 'normal' ),
	...
	function twitter_box() {
		echo '<div class="rss-widget">';
		wp_widget_rss_output( self::TWITTER_FEED, array( 'items' => 3, 'show_author' => 0, 'show_date' => 1, 'show_summary' => 0 ) );
		echo '</div>';
	}

...
function jr_submit_resume_form( $resume_id = 0 ) {
	...
	?>" method="post" enctype="multipart/form-data" id="submit_form" class="submit_form main_form">
		...
		<fieldset>
			...
			<p class="optional"><label for="desired_salary"><?php _e('Desired Salary<br/>(only numeric values or decimal points)', APP_TD); ?></label> <input type="text" class="tags text" name="desired_salary" id="desired_salary" placeholder="<?php _e('e.g. 25000', APP_TD); ?>" value="<?php if (isset($posted['desired_salary'])) echo $posted['desired_salary']; ?>" /></p>

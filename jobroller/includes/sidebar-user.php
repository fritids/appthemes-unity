...
<li class="widget widget_user_options">
	...
	<div class="widget_content">
		<ul>
			<?php if (is_user_logged_in()) : ?><li><a href="<?php echo get_permalink(get_option('jr_dashboard_page_id')) ?>"><?php _e('My Dashboard',APP_TD)?></a></li><?php endif; ?>
			<li><a href="<?php
			...
			<li><a href="<?php echo get_permalink(get_option('jr_user_profile_page_id')) ?>"><?php _e('Edit Profile',APP_TD)?></a></li>
...
<li class="widget widget_user_info">
	...
	<div class="widget_content">
		<ul>
			...
			?></li>
			<li><strong><?php _e('Member Since:',APP_TD)?></strong> <?php appthemes_get_reg_date($userdata->user_registered); ?></li>
			<li><strong><?php _e('Last Login:',APP_TD); ?></strong> <?php appthemes_get_last_login($userdata->ID); ?></li>
		</ul>
	</div>

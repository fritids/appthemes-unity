...
<div id="browseby" class="tabbed_section"><div class="contents">
    <ul>
		...
		if ($datepage = get_option('jr_date_archive_page_id')) :
                    ...
                    echo '<li><a href="'.add_query_arg('show', 'today', $datepagelink).'">'.__('Today',APP_TD).'</a></li>';
                    echo '<li><a href="'.add_query_arg('show', 'week', $datepagelink).'">'.__('This Week',APP_TD).'</a></li>';
                    echo '<li><a href="'.add_query_arg('show', 'lastweek', $datepagelink).'">'.__('Last Week',APP_TD).'</a></li>';
                    echo '<li><a href="'.add_query_arg('show', 'month', $datepagelink).'">'.__('This Month',APP_TD).'</a></li>';
                    echo '</ul></li>';
		endif;
		?>

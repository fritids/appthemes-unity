 ...
 */
	...
	$sql_overall = "SELECT * FROM $wpdb->app_pop_total a INNER JOIN $wpdb->posts p ON p.ID = a.postnum WHERE postcount > 0 AND post_status = 'publish' AND post_type = 'post' ORDER BY postcount DESC LIMIT 5";
